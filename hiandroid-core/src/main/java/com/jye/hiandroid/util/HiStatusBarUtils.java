...
public class HiStatusBarUtils {
    ...
    private static boolean supportTranslucent() {
        return Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT
                ...
                && !(HiDeviceUtils.isEssentialPhone() && Build.VERSION.SDK_INT < 26);
    }
    ...
    public static void translucent(Window window, @ColorInt int colorOn5x) {
        ...
        if (HiNotchHelper.isNotchOfficialSupport()) {
            handleDisplayCutoutMode(window);
        }

        // 小米和魅族4.4 以上版本支持沉浸式
        // 小米 Android 6.0 ，开发版 7.7.13 及以后版本设置黑色字体又需要 clear FLAG_TRANSLUCENT_STATUS, 因此还原为官方模式
        if (HiDeviceUtils.isFlymeLowerThan(8) || (HiDeviceUtils.isMIUI() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M)) {
...
//            }
    ...
    private static boolean isMIUICustomStatusBarLightModeImpl() {
        if (HiDeviceUtils.isMIUIV9() && Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            return true;
        }
        return HiDeviceUtils.isMIUIV5() || HiDeviceUtils.isMIUIV6() ||
                HiDeviceUtils.isMIUIV7() || HiDeviceUtils.isMIUIV8();
    }
    ...
    public static boolean FlymeSetStatusBarLightMode(Window window, boolean light) {
        ...
        if (window != null) {
            ...
            if (HiDeviceUtils.isFlymeLowerThan(7)) {
                try {
    ...
    public static boolean supportTransclentStatusBar6() {
        return !(HiDeviceUtils.isZUKZ1() || HiDeviceUtils.isZTKC2016());
    }
    ...
    private static void initStatusBarHeight(Context context) {
        ...
        if (HiDeviceUtils.isTablet(context)
                && sStatusBarHeight > HiDisplayUtils.dp2px(context, STATUS_BAR_DEFAULT_HEIGHT_DP)) {
