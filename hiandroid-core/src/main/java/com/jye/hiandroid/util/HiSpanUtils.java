...
public class HiSpanUtils {
     ...
     *             </ul>
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setStrikethrough() {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setUnderline() {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setSuperscript() {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setSubscript() {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final Blur style) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                 final float dx,
                                 final float dy,
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link HiSpanUtils} instance
     */
    public HiSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
